...
%         'sliderstep',[1/30 2/30]);
    uicontrol('style','text','pos',[480 300 100 30],'string','absolute overlap (ms)');
    h_slider = uicontrol('style','slider','pos',[520 270 100 30],'min',0,...
        'max',10e3,'value',0,'callback',{@EasyDIAg_slider,h_fig},...
        'sliderstep',[1/1000 2/1000]);
    
    h_overlap = uicontrol('style','text','pos',[480 270 30 30],'string',0);
...
function EasyDIAg_calc(hObject,eventdata,h_fig)
    ...
    [agStr,agMatGl] = process_DV_file_absolute(anno,value);
